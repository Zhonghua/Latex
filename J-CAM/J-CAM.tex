...
types of singularities, disruptions, and oscillations. They are a great basis for comparison 
of performance of adaptive FEM codes. In this paper we present results obtained
with the open source library Hermes (http://hpfem.org), and we hope that authors of 
other adaptive FEM codes, both academic and commercial, will follow. 
\end{abstract}
...
ways of loading the physical model, mesh formats, boundary conditions 
...
here, make it difficult to assess and compare their accuracy and performance.
...
and $hp$-DG solvers (http://hpfem.org).
In the following, each section contains a short description of the benchmark problem
followed by results and convergence graphs in terms of degrees
...
Solved it the Poisson's equation
